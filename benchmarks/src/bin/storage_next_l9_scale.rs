...
fn print_result(result: &RunResult) {
    ...
    if let Some(perf_trace) = result.perf_trace {
        eprintln!(
            "    perf-trace read_views={} read_view_rows={} append_clones={} append_clone_rows={} blind_conflict_sources={} point_rows_visited={} point_candidates={} scan_rows_visited={} scan_candidates={} table_seeks={}",
            ...
            perf_trace.blind_conflict_sources_built(),
        ...
        if let Some(perf_trace) = self.perf_trace {
            parameters.insert(
                ...
                serde_json::json!({
                    ...
                    "blind_conflict_sources_built": perf_trace.blind_conflict_sources_built(),
