...
9. `docs/architecture/engine-next/control-plane-layout-contract.md`
10. `docs/architecture/engine-next/retrieval-and-derived-state-contract.md`
11. `docs/architecture/engine-next/persistence-adapter-contract.md`
12. `docs/architecture/engine-next/ipc-and-command-boundary-contract.md`
