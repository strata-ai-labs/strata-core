...
`docs/architecture/engine-next-architecture.md`. This index lists the follow-up
...
5. `docs/architecture/engine-next/README.md`
...
Path: `docs/architecture/engine-next/primitive-implementation-contract.md`
...
Path: `docs/architecture/engine-next/entity-ref-and-relationship-layer-contract.md`
...
Path: `docs/architecture/engine-next/storage-space-id-registry.md`
...
Path: `docs/architecture/engine-next/persistence-adapter-contract.md`
...
Path: `docs/architecture/engine-next/branch-operation-and-capability-adapter-contract.md`
...
Path: `docs/architecture/engine-next/temporal-context-and-timeline-resolver-contract.md`
...
Path: `docs/architecture/engine-next/control-plane-layout-contract.md`
...
Path: `docs/architecture/engine-next/retrieval-and-derived-state-contract.md`
...
Path: `docs/architecture/engine-next/ipc-and-command-boundary-contract.md`
...
Path: `docs/architecture/engine-next/dataset-clone-artifact-contract.md`
...
Path: `docs/architecture/engine-next/public-api-and-cli-surface-cleanup-checklist.md`
...
Path: `docs/architecture/engine-next/product-pathway-conformance-plan.md`
...
Path: `docs/architecture/engine-next/error-and-diagnostics-contract.md`
...
Path: `docs/architecture/engine-next/testing-and-conformance-plan.md`
...
Path: `docs/architecture/engine-next/target-crate-shape-and-test-harness.md`
