...
**Layer:** vector indexing is an **engine-next capability** layered over the storage substrate — `storage-next` stays semantics-free (see §2.5). Filed under `docs/architecture/engine-next/`.
