...
8. `docs/architecture/engine-next/dataset-clone-artifact-contract.md`
9. `docs/architecture/engine-next/branch-operation-and-capability-adapter-contract.md`
10. `docs/architecture/engine-next/temporal-context-and-timeline-resolver-contract.md`
11. `docs/architecture/engine-next/retrieval-and-derived-state-contract.md`
