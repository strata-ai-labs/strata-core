...
5. `docs/architecture/engine-next-architecture.md`
6. `docs/architecture/engine-next/README.md`
7. `docs/architecture/engine-next/persistence-adapter-contract.md`
8. `docs/architecture/engine-next/temporal-context-and-timeline-resolver-contract.md`
9. `docs/architecture/engine-next/retrieval-and-derived-state-contract.md`
