...
8. `docs/architecture/engine-next-architecture.md`
9. `docs/architecture/storage-next/commit-timeline-substrate.md`
10. `docs/architecture/storage-next/l9-storage-api-boundary.md`
11. `docs/architecture/engine-next/primitive-implementation-contract.md`
12. `docs/architecture/engine-next/entity-ref-and-relationship-layer-contract.md`
13. `docs/architecture/engine-next/persistence-adapter-contract.md`
14. `docs/architecture/engine-next/branch-operation-and-capability-adapter-contract.md`
