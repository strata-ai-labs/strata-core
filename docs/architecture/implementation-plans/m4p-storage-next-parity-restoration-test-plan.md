...
| L7 Commit Runtime | Conflict/CAS/read-set tests, timeline tests, durable gate tests, replay tests, generation/quiesce tests. | Commits become visible out of order, miss conflicts, or classify durable ambiguity incorrectly. |
