...
| G10 | Admission thresholds tight + abrupt vs RocksDB (L0 urgent/block 8/16 vs slowdown/stop 20/36) | `compaction.rs:33-47`, config comment | grades regraded to 20/36 + C3 tier matrix (BS3.4a ✓); debt-adaptive rate ramp pending (BS3.4b) | **BS3.4a done; BS3.4b pending** |
