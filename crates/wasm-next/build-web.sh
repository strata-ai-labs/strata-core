...
cargo build --target wasm32-unknown-unknown --release -p strata-wasm-next
wasm-bindgen --target web \
  --out-dir crates/wasm-next/www/pkg \
  target/wasm32-unknown-unknown/release/strata_wasm_next.wasm

echo
echo "Built. Serve the playground with:"
echo "  python3 -m http.server 8080 --directory crates/wasm-next/www"
