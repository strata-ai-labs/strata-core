...
```json
{"data":{"applied":true,"commit":{"delete_count":0,"durable":false,"put_count":1,"timestamp":3,"version":3},"items":[{"applied":true,"commit":{"delete_count":0,"durable":false,"put_count":1,"timestamp":3,"version":3},"effect":{"affected_count":1,"applied":true,"kind":"created","matched":false},"error":null,"index":0,"result":{"key":"YQ=="},"status":"ok"}],"mode":"itemwise","status":"ok"},"type":"batch_results"}
{"data":{"applied":false,"commit":null,"items":[{"applied":false,"commit":null,"effect":null,"error":null,"index":0,"result":{"exists":true,"key":"YQ=="},"status":"ok"},{"applied":false,"commit":null,"effect":null,"error":null,"index":1,"result":{"exists":false,"key":"bWlzc2luZw=="},"status":"ok"}],"mode":"itemwise","status":"ok"},"type":"batch_exists_results"}
```
