...
{"data":{"coefficients":{"a":0.0,"b":0.0,"c":0.0},"graph":"g"},"type":"graph_lcc_result"}
```
...
```text
strata graph lcc <graph> [--as-of <integer>] [--budget <GraphAnalyticsBudget>] [--branch <branch>] [--space <space>]
```
