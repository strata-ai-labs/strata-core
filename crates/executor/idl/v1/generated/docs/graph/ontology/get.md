...
{"data":{"graph":"g","object_types":[{"name":"person"}],"status":"draft","timestamp":4,"version":4},"type":"graph_ontology_result"}
```
...
```text
strata graph ontology get <graph> [--as-of <integer>] [--branch <branch>] [--space <space>]
```
