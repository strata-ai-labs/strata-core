...
{"data":{"commit":{"delete_count":1,"durable":false,"put_count":0,"timestamp":7,"version":7},"dst":"bob","edge_type":"knows","effect":{"affected_count":1,"applied":true,"kind":"deleted","matched":true},"graph":"social","src":"alice"},"type":"graph_delete_result"}
...
```text
strata graph remove-edge <graph> <src> <edge_type> <dst> [--branch <branch>] [--space <space>]
```
