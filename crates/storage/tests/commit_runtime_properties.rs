...
fn commit_runtime_property_harness_runs_scaffold_contract() {
    ...
    use strata_storage::testkit::check_commit_runtime_scaffold_contract;
...
fn commit_runtime_property_harness_compares_generated_scripts_to_model() {
    ...
    use proptest::test_runner::TestCaseError;
    use proptest::test_runner::{Config, FileFailurePersistence, TestRunner};
    use strata_storage::testkit::check_commit_runtime_generated_input_contract;
...
fn all_categories_exercised(
    outcome: &strata_storage::testkit::CommitRuntimeScaffoldOutcome,
) -> bool {
...
fn assert_required_generated_categories(
    outcome: &strata_storage::testkit::CommitRuntimeAssuranceOutcome,
) {
