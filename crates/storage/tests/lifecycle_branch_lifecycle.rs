...
fn lifecycle_branch_lifecycle_cache_smoke() {
    let outcome = strata_storage::testkit::check_lifecycle_branch_lifecycle_contract(
...
fn lifecycle_branch_lifecycle_recovery_smoke() {
    let outcome = strata_storage::testkit::check_lifecycle_branch_lifecycle_recovery_contract(
