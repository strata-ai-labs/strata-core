...
fn lifecycle_recovery_fuzz_seed_hits_valid_and_corrupt_routes() {
    let outcome = strata_storage::testkit::check_lifecycle_recovery_fuzz_contract(&seed_bytes(
        "lifecycle_recovery",
        "mixed_seed",
    ))
...
fn lifecycle_maintenance_fuzz_seed_hits_task_and_close_routes() {
    let outcome = strata_storage::testkit::check_lifecycle_maintenance_fuzz_contract(&seed_bytes(
        "lifecycle_maintenance",
        "close_seed",
    ))
...
fn lifecycle_maintenance_fuzz_regression_keeps_materialization_branches_distinct() {
    ...
    let outcome = strata_storage::testkit::check_lifecycle_maintenance_fuzz_contract(&script)
        .expect("maintenance fuzz contract");
...
fn lifecycle_retention_fuzz_seed_hits_delete_and_defer_routes() {
    let outcome = strata_storage::testkit::check_lifecycle_retention_fuzz_contract(&seed_bytes(
        "lifecycle_retention",
        "purge_seed",
    ))
