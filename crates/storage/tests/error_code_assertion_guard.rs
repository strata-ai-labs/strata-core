...
const ALLOWED_UNASSERTED: &[(&str, &str)] = &[
    ...
    ("already_exists.branch.branch_id", "branch inner code, now boundary-carried; asserted by TCP3.2b per-variant tests"),
    ...
    ("failed_precondition.branch.compaction_candidate_missing_level", "branch inner code, now boundary-carried; asserted by TCP3.2b per-variant tests"),
    ("failed_precondition.branch.compaction_candidate_missing_table", "branch inner code, now boundary-carried; asserted by TCP3.2b per-variant tests"),
    ("failed_precondition.branch.compaction_candidate_stale", "branch inner code, now boundary-carried; asserted by TCP3.2b per-variant tests"),
    ("failed_precondition.branch.config", "branch inner code, now boundary-carried; asserted by TCP3.2b per-variant tests"),
    ("failed_precondition.branch.inherited_layer", "branch inner code, now boundary-carried; asserted by TCP3.2b per-variant tests"),
    ("failed_precondition.branch.insufficient_timestamp_history", "branch inner code, now boundary-carried; asserted by TCP3.2b per-variant tests"),
    ("failed_precondition.branch.invalid_compaction", "branch inner code, now boundary-carried; asserted by TCP3.2b per-variant tests"),
    ("failed_precondition.branch.publish", "branch inner code, now boundary-carried; asserted by TCP3.2b per-variant tests"),
    ("failed_precondition.branch.reachability", "branch inner code, now boundary-carried; asserted by TCP3.2b per-variant tests"),
    ("failed_precondition.branch.row", "branch inner code, now boundary-carried; asserted by TCP3.2b per-variant tests"),
    ("failed_precondition.branch.row_pruning_inherited_layer_unknown", "branch inner code, now boundary-carried; asserted by TCP3.2b per-variant tests"),
    ("failed_precondition.branch.row_pruning_inherited_layer_unsafe", "branch inner code, now boundary-carried; asserted by TCP3.2b per-variant tests"),
    ("failed_precondition.branch.row_pruning_pinned_view_below_floor", "branch inner code, now boundary-carried; asserted by TCP3.2b per-variant tests"),
    ("failed_precondition.branch.row_pruning_proof_branch_mismatch", "branch inner code, now boundary-carried; asserted by TCP3.2b per-variant tests"),
    ("failed_precondition.branch.row_pruning_proof_epoch_invalid", "branch inner code, now boundary-carried; asserted by TCP3.2b per-variant tests"),
    ("failed_precondition.branch.row_pruning_proof_fingerprint_invalid", "branch inner code, now boundary-carried; asserted by TCP3.2b per-variant tests"),
    ("failed_precondition.branch.row_pruning_proof_missing", "branch inner code, now boundary-carried; asserted by TCP3.2b per-variant tests"),
    ("failed_precondition.branch.row_pruning_proof_stale", "branch inner code, now boundary-carried; asserted by TCP3.2b per-variant tests"),
    ("failed_precondition.branch.row_pruning_proof_unsafe_recovery_health", "branch inner code, now boundary-carried; asserted by TCP3.2b per-variant tests"),
    ("failed_precondition.branch.row_pruning_proof_visible_version_below_state", "branch inner code, now boundary-carried; asserted by TCP3.2b per-variant tests"),
    ("failed_precondition.branch.row_pruning_retained_floor_above_visible", "branch inner code, now boundary-carried; asserted by TCP3.2b per-variant tests"),
    ("failed_precondition.branch.row_pruning_retained_timestamp_floor_missing", "branch inner code, now boundary-carried; asserted by TCP3.2b per-variant tests"),
    ("failed_precondition.branch.row_pruning_shared_table_safety_unknown", "branch inner code, now boundary-carried; asserted by TCP3.2b per-variant tests"),
    ("failed_precondition.branch.row_pruning_table_manifest_coverage_beyond_floor", "branch inner code, now boundary-carried; asserted by TCP3.2b per-variant tests"),
    ("failed_precondition.branch.row_pruning_timestamp_floor_without_coverage", "branch inner code, now boundary-carried; asserted by TCP3.2b per-variant tests"),
    ("failed_precondition.branch.row_pruning_tombstone_elision_missing", "branch inner code, now boundary-carried; asserted by TCP3.2b per-variant tests"),
    ("failed_precondition.branch.row_pruning_tombstone_elision_not_bottommost", "branch inner code, now boundary-carried; asserted by TCP3.2b per-variant tests"),
    ("failed_precondition.branch.row_pruning_tombstone_resurrection_risk", "branch inner code, now boundary-carried; asserted by TCP3.2b per-variant tests"),
    ("failed_precondition.branch.row_pruning_ttl_cutoff_exceeds_timestamp_floor", "branch inner code, now boundary-carried; asserted by TCP3.2b per-variant tests"),
    ("failed_precondition.branch.row_pruning_ttl_elision_missing", "branch inner code, now boundary-carried; asserted by TCP3.2b per-variant tests"),
    ("failed_precondition.branch.row_pruning_ttl_elision_not_bottommost", "branch inner code, now boundary-carried; asserted by TCP3.2b per-variant tests"),
    ("failed_precondition.branch.snapshot_install", "branch inner code, now boundary-carried; asserted by TCP3.2b per-variant tests"),
    ("failed_precondition.branch.table_runtime", "branch inner code, now boundary-carried; asserted by TCP3.2b per-variant tests"),
