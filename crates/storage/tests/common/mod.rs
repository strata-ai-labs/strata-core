...
pub(crate) const COMPOUND_CASES_ENV: &str = "STRATA_STORAGE_COMPOUND_CASES";
...
pub(crate) fn compound_case_limit() -> Result<Option<usize>, HarnessConfigError> {
    parse_env_usize(COMPOUND_CASES_ENV)
}
