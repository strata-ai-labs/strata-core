...
fn fs_persistence_models_recover_prefix_of_acknowledged_history() {
    ...
    let outcome = strata_storage::testkit::run_fs_model_harness(&root, case_limit.or(Some(120)))
...
fn fs_persistence_models_soak_deepens_across_many_seeds() {
    ...
    let outcome =
        strata_storage::testkit::run_fs_model_harness(tempdir.path(), case_limit.or(Some(20_000)))
