...
impl CommitReplayRequest {
    ...
    pub(crate) fn branch_id(&self) -> strata_core::BranchId {
        self.record.branch_id()
    }

    pub(crate) fn commit_version(&self) -> strata_core::CommitVersion {
        self.record.commit_version()
    }

    pub(crate) fn commit_timestamp(&self) -> strata_core::Timestamp {
