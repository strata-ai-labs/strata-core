//! Public API snapshot guard for strata-core.
...
fn public_api_matches_snapshot() {
    ...
    assert_eq!(
        ...
        "strata-core public API changed; update the boundary document and snapshot together"
    );
}
...
fn current_public_api_snapshot() -> String {
    ...
    let mut lines = vec![
        "# strata-core public API snapshot".to_owned(),
        "# This file is checked by tests/public_api_snapshot.rs.".to_owned(),
        "crate strata_core".to_owned(),
    ];
