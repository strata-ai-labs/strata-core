...
pub use api::{
    ...
    GraphProperties, GraphService, GraphWriteOutcome, JsonBatchDeleteOutcome,
    ...
    ProductSpace, SpaceCatalogDiagnostics, VectorBatchDeleteOutcome, VectorBatchGetOutcome,
