...
use strata_engine_next::{
    ...
    GraphLinkTypeDef as EngineGraphLinkTypeDef, GraphName as EngineGraphName,
    GraphNamePage as EngineGraphNamePage, GraphNeighbor as EngineGraphNeighbor,
    GraphNeighborPage as EngineGraphNeighborPage, GraphNode as EngineGraphNode,
    GraphNodeData as EngineGraphNodeData, GraphNodeId as EngineGraphNodeId,
    GraphNodePage as EngineGraphNodePage, GraphObjectTypeDef as EngineGraphObjectTypeDef,
    GraphOntology as EngineGraphOntology,
    ...
    GraphProperties as EngineGraphProperties, GraphPropertyDef as EngineGraphPropertyDef,
    GraphService, GraphTypeName as EngineGraphTypeName,
