...
pub use api::{
    ...
    DatabaseOpenTarget, DurabilityMode, DurableLocalOpenOptions, EngineError, EngineErrorClass,
    EngineErrorStatus, EngineResult, ErrorClass, ErrorCodeRegistryEntry, ErrorDetail,
