...
pub use api::{
    ...
    KvScanRow, KvService, KvValue, KvVersionedValue, KvWriteOutcome, ProductSpace, RetryPolicy,
    SpaceCatalogDiagnostics, SpaceCreateOutcome, SpaceDeleteOutcome, SpaceService,
