...
pub use api::{
    ...
    BranchService, BranchStatus, BranchSummary, CacheOpenOptions, CachePreheat, CloseOutcome,
    CommitDurability, CommitOutcomeStatus, ComparedCapability, ComparedEntity, ControlDiagnostics,
    ControlHealthStatus, Database, DatabaseOpenOutcome, DatabaseOpenSummary, DatabaseOpenTarget,
    DurabilityMode, DurableLocalOpenOptions, EngineError, EngineErrorClass, EngineErrorStatus,
    ...
    ProductSpace, RetryPolicy, SpaceCatalogDiagnostics, SpaceComparison, SpaceCreateOutcome,
    SpaceDeleteOutcome, SpaceService, SpaceUsageSummary, VectorArtifactSourceDiagnostic,
